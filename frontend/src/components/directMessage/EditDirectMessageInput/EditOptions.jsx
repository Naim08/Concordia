import "../../message/MessageList/MessageItem/EditOptions/EditOptions.css";
...
import DirectMessageDeleteForm from "./DeleteForm";

const DirectMessageEditOptions = ({
  messageId,
  message,
  date,
  extraTimeInfo,
  ...
  const handleDelete = (e) => {
    ...
    if (quickDelete) {
      ...
      setDisabled(true);
      dispatch(deleteDirectMessage(messageId));
    } else {
...
export default DirectMessageEditOptions;
